...
namespace CleanArchitecture.Infrastructure
{
    public static class ServiceRegistration
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IBorrowRepositoryAsync, BorrowRepositoryAsync>();            
            services.AddTransient<IFineRepositoryAsync, FineRepositoryAsync>();
            ...
            services.AddTransient<IWaitlistRepositoryAsync, WaitlistRepositoryAsync>();
            #endregion
        }
    }
}
